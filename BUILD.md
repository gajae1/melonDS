...
C++26. See [release scope and tested configurations](plans/releases/1.1.04.md),
...
[the release record](plans/releases/1.1.04.md) for verified and unverified configurations.
