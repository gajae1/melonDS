...
현재 변경의 범위·실제 검증은 [1.1.138 기록](releases/1.1.138.md)을 따른다.
...
| Vulkan 확대 | 1~16배 직접 3D·LCDC 표시, bitmap BG2/BG3 및 일반·반전·affine direct-color bitmap OBJ의 캡처 디테일 | 모자이크 OBJ 향상, 3D texture 재사용, 색인 bitmap 향상; 변환 OBJ 검증은 양 engine 1·3·5배율 |
