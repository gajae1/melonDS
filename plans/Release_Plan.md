...
최근 [실제 1.1.26 증분](releases/1.1.26.md)은 GR-03, AD-09~13, NP-03의 독립 블록을 함께 반영했다. 설정창 상태, DSi 직접 부팅과 metadata, SD 전송 오류, LocalMP 큐 복구의 검증 범위를 기록했으며 아래 책임 버전들의 전체 완료를 뜻하지 않는다.
