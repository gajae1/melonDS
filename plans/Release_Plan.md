...
최근 [실제 1.1.30 증분](releases/1.1.30.md)은 NP-02/FS-17의 LAN mesh, AD-05의 성공 load/undo 오디오 이력, CJ-19/GR-05/06의 DMA-first와 warmed JIT 캡처 수락을 다룬다. [1.1.29](releases/1.1.29.md)의 LAN 수명·입력 배정·DSi 타이틀 교체와 함께 독립 반례의 구현 범위를 기록하며 아래 책임 버전들의 전체 완료를 뜻하지 않는다. [1차 코드 감사](Audit_2026-09-11.md)는 미검토 범위·추가 후보·플랫폼 계약을 구분한다.
