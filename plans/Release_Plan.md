...
최근 [실제 1.1.29 증분](releases/1.1.29.md)은 NP-02/FS-17의 LAN 연결·취소·수명, FS-12의 입력 배정, FS-16의 DSi 타이틀 교체를 함께 다룬다. [1.1.28](releases/1.1.28.md)의 캡처·AES·DSi reset/I2C와 함께 독립 반례의 구현 범위를 기록하며 아래 책임 버전들의 전체 완료를 뜻하지 않는다.
