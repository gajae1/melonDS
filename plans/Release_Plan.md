...
최근 [실제 1.1.31 증분](releases/1.1.31.md)은 FS-02의 SD 이미지 오류 후 보존, AD-21의 BTDMP 홀수 FIFO, GR-02의 Compute 초기화를 다룬다. [1.1.30](releases/1.1.30.md)의 LAN mesh·성공 load/undo 오디오·DMA-first/warmed JIT 캡처와 함께 독립 반례의 구현 범위를 기록하며 아래 책임 버전들의 전체 완료를 뜻하지 않는다. [1차 코드 감사](Audit_2026-09-11.md)는 미검토 범위·추가 후보·플랫폼 계약을 구분한다.
