...
최근 [실제 1.1.35 증분](releases/1.1.35.md)은 LAN의 남은 대기·중복 트래픽 상한과 느린 참가자 유지, 빈 Thumb PUSH/POP의 관측·정상 LR/PC 명령 검증을 다룬다. [1.1.34](releases/1.1.34.md)의 alpha·fog·조건부 사이클·배포 결속과 함께 재현한 독립 결함의 구현 범위를 기록하며, 아래 책임 버전의 Vulkan·다른 플랫폼·실기 수락이 완료됐다는 의미는 아니다. [1차 코드 감사](Audit_2026-09-11.md)는 미검토 범위와 추가 후보를 구분한다.
