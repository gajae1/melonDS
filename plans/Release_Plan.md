...
최근 [실제 1.1.28 증분](releases/1.1.28.md)은 GR-05의 캡처 중간 접근, AD-14의 CCM 태그, AD-17/22의 DSi reset/I2C를 함께 다룬다. [1.1.27](releases/1.1.27.md)의 software 3D 대기·NDMA 정지·WMI 응답과 함께 독립 반례의 구현 범위를 기록하며 아래 책임 버전들의 전체 완료를 뜻하지 않는다.
