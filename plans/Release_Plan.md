...
최근 [실제 1.1.27 증분](releases/1.1.27.md)은 GR-13의 렌더 대기, AD-16의 NDMA GX 정지, NP-08의 DSi WMI 응답을 함께 반영했다. [1.1.26](releases/1.1.26.md)의 DSi 부팅·SD·LocalMP·설정 복구와 함께 독립 반례의 구현 범위를 기록하며 아래 책임 버전들의 전체 완료를 뜻하지 않는다.
