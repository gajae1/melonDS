...
| BV-05 | [배포 allowlist·개인 자료 보존](workstreams/06-build-validation.md#BV-05) | 실패 실행 재현 | P1 | [1.1.43](Release_Plan.md#v43) | — | 1.1.03 선별 배포; 1.1.34 소스 변경 후 오래된 EXE 거부·문서만 변경 재사용, 외부 DLL/재현 빌드 신원은 별도; 1.1.43 사전 생성 fixture의 임의 txt/json/jpg 등5파일 ZIP 포함 재현, exact allowlist 수정 다음 |
