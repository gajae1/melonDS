...
''', encoding='utf-8')
    ...
    def test_explicit_mapping_closure_licenses_and_hashes(self):
        ...
        expected = {'9.9.90-melonDS.exe', 'bridge.dll', 'leaf.dll', 'platforms/plugin.dll', 'LICENSE',
                    ...
                    'third-party-licenses/r8brain/LICENSE'}
        ...
        self.assertEqual(sha(self.runtime / 'third-party-licenses/r8brain/LICENSE'), sha(ROOT / 'src/audio_interpolation/LICENSE.r8brain'))
