...
if (TARGET melonds-gdb-context)
    target_link_libraries(StateLoadMessages PRIVATE melonds-gdb-context)
endif()
if (ENABLE_GDBSTUB)
    add_test(NAME gdb-suspended-state-message COMMAND StateLoadMessages gdb-suspended)
    set_tests_properties(gdb-suspended-state-message PROPERTIES TIMEOUT 10)
endif()
if (USE_QT6)
...
foreach(case IN ITEMS ds-invalid gba-invalid ds-writable gba-writable ds-existing-writable gba-existing-writable
        ...
        ds-capacity-unknown ds-capacity-metadata ds-capacity-unsupported ds-capacity-state ds-capacity-flash ds-capacity-profile ds-capacity-protection ds-capacity-flash-protection ds-capacity-flash-extended-erase
...
foreach(case IN ITEMS roundtrip serialize-error serialize-reject short-write write-error commit-failure transient-commit-failure)
