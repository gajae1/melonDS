...
if (TARGET core AND (TARGET Qt6::Core OR MELONDS_TEST_DSI_BOOT_FRONTEND))
    ...
    foreach(method IN ITEMS BuildPath RetryCapture FlushSave FlushAll AssetPath SaveError ReadSave LoadROM LoadGBA UpdateConsole Reset BootToMenu)
    ...
    foreach(case IN ITEMS retain late success firmware firmware-retain legacy-ds-reset-success legacy-ds-queued-failure legacy-asset-reset-failure)
