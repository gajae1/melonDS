...
RangeList IntRanges =
{
    ...
    {"Instance*.Firmware.Language", {0, 7}},
    {"Instance*.Firmware.FavouriteColour", {0, 15}},
    {"Instance*.Firmware.BirthdayMonth", {1, 12}},
    {"Instance*.Firmware.BirthdayDay", {1, 31}},
